...
- `AGENTS.md` ← `CLAUDE.md`, with Claude Code-specific wording adapted for riffer-rig. Commit-trailer and PR-footer attribution names the agent doing the work (`Claude` in `.claude/`, `Riffer` in `.riffer/`).
